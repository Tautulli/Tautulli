    ...
    def get_datatables_list(self, kwargs=None, grouping=None):
        ...
        try:
            query = data_tables.ssp_query(table_name='library_sections',
                                          ...
                                          join_types=['LEFT OUTER JOIN MULTIPLE',
                                                      'LEFT OUTER JOIN',
                                                      'LEFT OUTER JOIN'],
                                          join_tables=['session_history',
                                                       'session_history_metadata',
                                                       'session_history_media_info'],
                                          join_evals=[['session_history.section_id = library_sections.section_id', 'session_history.server_id = library_sections.server_id'],
