...
_CONFIG_DEFINITIONS = {
    ...
    'PROMETHEUS_HTTP_AUTH': (int, 'General', 0),
    'PROMETHEUS_HTTP_USERNAME': (str, 'General', ''),
    'PROMETHEUS_HTTP_PASSWORD': (str, 'General', ''),
...
_DO_NOT_DOWNLOAD_KEYS = [
    'PMS_TOKEN', 'JWT_SECRET', 'PROMETHEUS_HTTP_PASSWORD'
]
...
SETTINGS = [
    ...
    'PROMETHEUS_HTTP_PASSWORD',
    'PROMETHEUS_HTTP_USERNAME',
    'PMS_CLIENT_ID',
    'PMS_IDENTIFIER',
    'PMS_IP',
    'PMS_IS_CLOUD',
