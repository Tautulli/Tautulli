...
_CONFIG_DEFINITIONS = {
    ...
    'SECURITY_ENABLED': (int, 'Security', 0),
    'SECURITY_BLACKLIST_ENABLED': (int, 'Security', 0),
    'SECURITY_SHARING_DETECTION': (int, 'Security', 0),
    'SECURITY_SHARING_CHECK_INTERVAL': (int, 'Security', 300),
    'SECURITY_IMPOSSIBLE_TRAVEL_SPEED': (int, 'Security', 500),
    'SECURITY_GEOLOCATION_ENABLED': (int, 'Security', 0),
    'SECURITY_GEOLOCATION_DB': (str, 'Security', ''),
    'SECURITY_STREAM_BLOCKING': (int, 'Security', 0),
    'SECURITY_NOTIFY_VIOLATIONS': (int, 'Security', 1),
    'SECURITY_LOG_VIOLATIONS': (int, 'Security', 1),
}
...
SETTINGS = [
    ...
    'SECURITY_IMPOSSIBLE_TRAVEL_SPEED',
    'SECURITY_SHARING_CHECK_INTERVAL',
...
CHECKED_SETTINGS = [
    ...
    'SECURITY_ENABLED',
    'SECURITY_GEOLOCATION_ENABLED',
    'SECURITY_LOG_VIOLATIONS',
    'SECURITY_NOTIFY_VIOLATIONS',
    'SECURITY_SHARING_DETECTION',
    'SECURITY_STREAM_BLOCKING',
    'SYS_TRAY_ICON',
    'THEMOVIEDB_LOOKUP',
    'TVMAZE_LOOKUP',
    'WEEK_START_MONDAY',
