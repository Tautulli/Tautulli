...
_CONFIG_DEFINITIONS = {
    ...
    'DISCORD_ENABLED': (int, 'Discord', 0),
    'DISCORD_HOOK': (str, 'Discord', ''),
    'DISCORD_INCL_PMSLINK': (int, 'Discord', 0),
    'DISCORD_INCL_POSTER_INFO': (int, 'Discord', 0),
    'DISCORD_INCL_POSTER_IMG': (int, 'Discord', 0),
    'DISCORD_INCL_SUBJECT': (int, 'Discord', 1),
    'DISCORD_USERNAME': (str, 'Discord', ''),
    'DISCORD_ON_PLAY': (int, 'Discord', 0),
    'DISCORD_ON_STOP': (int, 'Discord', 0),
    'DISCORD_ON_PAUSE': (int, 'Discord', 0),
    'DISCORD_ON_RESUME': (int, 'Discord', 0),
    'DISCORD_ON_BUFFER': (int, 'Discord', 0),
    'DISCORD_ON_WATCHED': (int, 'Discord', 0),
    'DISCORD_ON_CREATED': (int, 'Discord', 0),
    'DISCORD_ON_EXTDOWN': (int, 'Discord', 0),
    'DISCORD_ON_INTDOWN': (int, 'Discord', 0),
    'DISCORD_ON_EXTUP': (int, 'Discord', 0),
    'DISCORD_ON_INTUP': (int, 'Discord', 0),
    'DISCORD_ON_PMSUPDATE': (int, 'Discord', 0),
    'DISCORD_ON_CONCURRENT': (int, 'Discord', 0),
    'DISCORD_ON_NEWDEVICE': (int, 'Discord', 0),
