...
_CONFIG_DEFINITIONS = {
    ...
    'OIDC_CONFIG_URL': (str, 'General', ''),
    'OIDC_CLIENT_ID': (str, 'General', ''),
    'OIDC_CLIENT_SECRET': (str, 'General', ''),
    'OIDC_PROVIDER_NAME': (str, 'General', 'OpenID'),
    'OIDC_GROUPS_CLAIM': (str, 'General', 'groups'),
    'OIDC_TLS_CACERT': (str, 'General', ''),
    'OIDC_ADMIN_GROUP': (str, 'General', ''),
