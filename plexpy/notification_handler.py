...
def build_media_notify_params(notify_action=None, session=None, timeline=None, manual_trigger=False, **kwargs):
    ...
    available_params = {
        ...
        'stream_audio_atmos': helpers.cast_to_int('atmos' in notify_params['stream_audio_profile'].lower()),
        ...
        'audio_atmos': helpers.cast_to_int('atmos' in notify_params['audio_profile'].lower()),
