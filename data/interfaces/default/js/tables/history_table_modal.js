            ...
            "createdCell": function (td, cellData, rowData, row, col) {
                if (cellData !== '') {
                    ...
                    if (rowData['media_type'] === 'movie') {
                        ...
                        $(td).html('<div class="history-title"><a href="' + info_page(rowData['rating_key'], rowData['guid'], true, rowData['live']) + '"><div style="float: left;">' + media_type + '&nbsp;' + thumb_popover + '</div></a></div>');
